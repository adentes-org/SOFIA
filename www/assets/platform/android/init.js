...
!function() {
    ...
    console.log("Init android platform"), $("head").append('<link rel="stylesheet" type="text/css" href="dist/lib/material-design-lite/material.min.css">'), 
        ...
        S.platform = {
            ...
            events: {
                ...
                afterPageLoad: function() {
                    window.setTimeout(componentHandler.upgradeDom, 250);
                }
            }
        };
    });
